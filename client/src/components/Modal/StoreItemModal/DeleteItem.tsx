...
export const DeleteItem = ({ handleClose, product }: { handleClose: () => void, product: IProduct }) => {
  const submitData = () => {
      ...
      <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div className="sm:flex sm:items-start">
          ...
          <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            ...
            <h3 className="text-base font-semibold leading-6 text-red-600"> "{product.title}" </h3>
            <div className="mt-2">
