...
export const Select = ({ handleCategoryChange, name, selected }: ISelect) => {
  ...
  return (
    <select className={name === 'search' ? searchStyle : formStyle} onChange={handleCategoryChange} id='category' defaultValue={selected}>
